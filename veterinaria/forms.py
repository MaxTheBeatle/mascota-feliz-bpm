...
from .models import Mascota, Cita, CarritoItem, Pedido, Veterinario, User, Medicamento, RecetaMedica, ItemReceta, ReservaMedicamento, ItemReserva, CategoriaFarmacia
